...
public class VotingResultsFromResultsController implements Observer{
    ...
    public void initialize() {
        ...
        VotingResultsFromResultsController current = this;
        ...
        isVotingResultsLoaded.addListener(new ChangeListener<Boolean>() {
            ...
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                if (newValue) {
                    chatAccess = VotingPromptFromResultsController.getChatAccess();
                    chatAccess.deleteObservers();
                    chatAccess.addObserver(current);
                    
                    for (Text t: VotingPromptFromResultsController.getTexts()){
                        texts.add(t);
